document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    const validateField = function (field) {
      ...
      const minlength = field.getAttribute('data-minlength') || field.getAttribute('minlength');
    ...
    const getFormFields = function () {
      return Array.from(
        ...
        return field.type !== 'submit' && field.type !== 'button' && field.type !== 'reset';
      });
    };
  ...
  const animatableEls = Array.from(document.querySelectorAll(OBSERVED_SELECTOR));
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4244d7f1-f988-46f8-879f-63f44250058a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4244d7f1-f988-46f8-879f-63f44250058a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1a4bc1a9-c0f5-4605-90e7-48789c9e6e35';
